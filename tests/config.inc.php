 ...
 */
    ...
    $this->dbName = 'oxid_shop_test'; // database name
    $this->dbUser = 'root'; // database user name
    $this->dbPwd = 'root'; // database user password
    $this->dbType = 'mysql';
    $this->sShopURL = 'http://www.oxid-test.dev'; // eShop base url, required
    $this->sSSLShopURL  = null;            // eShop SSL url, optional
    $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
    $this->sShopDir = '/var/www/oxid/source';
    $this->sCompileDir = '/var/www/oxid/source/tmp';
    ...
    /**
     * temporary disable seo urls
     */
    $this->blSeoMode = false;

$this->aUserComponents['mfcmp_bepado'] = 0;
