...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    ...
    <tr class="listitem">
        [{block name="admin_category_list_filter"}]
            ...
            <td valign="top" class="listfilter" height="20" colspan="3">
                <div class="r1"><div class="b1">
                <div class="find">
    ...
    <tr>
        [{block name="admin_category_list_sorting"}]
            ...
            <td class="listheader" height="15" ><a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxcategories', 'oxtitle', 'asc');document.search.submit();" class="listheader">[{ oxmultilang ident="GENERAL_TITLE" }]</a></td>
            <td class="listheader" height="15" colspan="2">[{ oxmultilang ident="BEPADO_CATEGORY" }]</td>
        [{/block}]
    </tr>
...
[{foreach from=$mylist item=listitem}]
    ...
    <tr id="row.[{$_cnt}]">
        [{block name="admin_category_list_item"}]
            ...
            <td valign="top" class="[{ $listclass}]" height="15"><div class="listitemfloating"><a href="Javascript:top.oxid.admin.editThis('[{ $listitem->oxcategories__oxid->value}]');" class="[{ $listclass}]">[{$listitem->oxcategories__bepadocategory->rawValue}]</a></div></td>
            <td class="[{ $listclass}]">
            [{if !$readonly }]
