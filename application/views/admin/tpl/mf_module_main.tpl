        ...
        <tr>
            <td width="245" valign="top">
                [{if $oModule->getInfo('thumbnail')}]
                    [{if $oModule->getInfo('title') === 'Bepado-Plugin' && $oModule->getInfo('url') }]
                        <a href="[{$oModule->getInfo('url')}]" target="_blank">
                    [{/if}]
                    <img src="[{ $oViewConf->getBaseDir() }]/modules/[{$oModule->getModulePath()}]/[{$oModule->getInfo('thumbnail')}]" hspace="20" vspace="10">
                    [{if $oModule->getInfo('title') === 'Bepado-Plugin' && $oModule->getInfo('url') }]
                        </a>
                    [{/if}]
                [{else}]
